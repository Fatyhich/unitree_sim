...
class G1_29_ArmController:
    ...
    def _ctrl_motor_state(self):
        while True:
            ...
            for idx, joint in enumerate(G1_29_JointIndex):
                self.msg.motor_cmd[joint].q = cliped_arm_q_target[idx]
                self.msg.motor_cmd[joint].dq = 0
                self.msg.motor_cmd[joint].tau = arm_tauff_target[idx]      
                self.msg.motor_cmd[joint].kp = Kp[idx]
                self.msg.motor_cmd[joint].kd = Kd[idx]
