    ...
    def LowCmdWrite(self):
        ...
        if self.time_ < self.duration_ :
          ...
          for i,joint in enumerate(self.arm_joints):
            ...
            if joint == G1JointIndex.WaistYaw or \
                joint == G1JointIndex.WaistRoll or \
                joint == G1JointIndex.WaistPitch:
                self.low_cmd.motor_cmd[joint].q = 0.
                self.low_cmd.motor_cmd[joint].dq = 0.
                self.low_cmd.motor_cmd[joint].kp = 250.
                self.low_cmd.motor_cmd[joint].kd = 3.5
